...
fn main(@builtin(global_invocation_id) global_id: vec3<u32>,
    ...
    for (var i: u32 = 0u; i < 256u; i++) {
        ...
        // Упрощённая проверка: влияние на тайл по радиусу источника
        // Для production нужно считать пересечение сферы с фрустумом тайла
        let in_tile = true; // заглушка — нужно реализовать проверку
